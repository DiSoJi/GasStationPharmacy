...
BEGIN
	...
	FROM ((SUCURSAL INNER JOIN SUC_MEDICAMENTO ON SUCURSAL.ID = SUC_MEDICAMENTO.IDSucursal) INNER JOIN MEDICAMENTO ON MEDICAMENTO.Nombre = SUC_MEDICAMENTO.NombreMedicamento) INNER JOIN CONT_PEDIDO ON CONT_PEDIDO.NombreMedicamento = MEDICAMENTO.Nombre
